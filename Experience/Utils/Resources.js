...
export default class Resources extends EventEmitter {
  constructor(assets) {
    ...
    this.items = {};
    this.queue = this.assets.length; //Esto nos dice cuanto ítems estan siendo cargados en queue
    this.loaded = 0;
  ...
  setLoaders() {
    ...
    this.loaders.dracoLoader.setDecoderPath("/draco/"); //Uso draco porque el modelo lo exporté con compresión usando Draco (como normalmente se hace en Blender)
